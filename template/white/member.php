...
<p class="copyright">贴吧签到助手 <?php echo 'Final'; ?> - Designed by <a href="http://www.ikk.me" target="_blank">kookxiang</a><br />Running on <a href="http://sign.loacg.com/" target="_blank">loacg.com</a><?php if(getSetting('beian_no')) echo ' - <a href="http://www.miibeian.gov.cn/" target="_blank" rel="nofollow">'.getSetting('beian_no').'</a>'; ?></p>
